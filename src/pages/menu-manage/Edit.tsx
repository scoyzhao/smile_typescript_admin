...
import { addCommite, editMenu } from '../../utils/api'
...
const Edit: React.FC<editProps> = ({ isShow, data, handleCancel, type }) => {
  ...
  console.log("🚀 ~ file: Edit.tsx ~ line 33 ~ data", data)
  ...
  const handleSubmit = async () => {
    try {
      ...
      const res = id !== undefined ? await editMenu({
        editMenu: {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Form.Item name="url" label="图片" rules={[{ required: true }]}>
          <Input />
        </Form.Item>
      </Form>
    </Modal>
